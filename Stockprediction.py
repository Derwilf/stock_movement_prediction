...
# IMPORTING DATASET
dataset = pdr.get_data_yahoo('FB', start="2017-01-01", end="2020-05-30")
# Remove two columns as index base
dataset.drop(dataset.columns[[4, 5]], axis=1, inplace=True)
...
plt.ylabel('OHLC Value of Facebook Stocks')
plt.show()
